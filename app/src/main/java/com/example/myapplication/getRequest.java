...
public class getRequest {
    ...
    private String APIkey = "16aeJTtUG53KwiFs";
    private String brainID = "171935";
    ...
    public void getResponse(String message, final VolleyResponseListener volleyResponseListener){
        ...
        String url = "http://api.brainshop.ai/get?bid=" + brainID+ "&key=" + APIkey + "&uid=1&msg=" + message;        Log.d("URL", url);
